  ...
  const launchRazorPay = () => {
      let options = {
          ...
          handler: () => {
              setIsOpen(false);
              alert("Payment Done");
          },// handler -> it will be exicuted after the payment is successful or failure is done
          theme: {color: "#c4242d"}, // it is for the razorpay background theme
      };
